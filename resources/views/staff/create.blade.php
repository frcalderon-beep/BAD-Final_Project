...
<div class="max-w-2xl mx-auto">
    <h1 class="text-4xl font-bold text-gray-800 mb-6">Add New Staff Member</h1>
    ...
    <div class="bg-white rounded-lg shadow-md p-8">
        <form action="{{ route('staff.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="assigned_appointment" name="assigned_appointment" value="{{ old('assigned_appointment') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">
            </div>

            <div class="flex gap-4">
                <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700">Create Staff</button>
                <a href="{{ route('staff.index') }}" class="bg-gray-500 text-white px-6 py-2 rounded hover:bg-gray-600">Cancel</a>
            </div>
        </form>
    </div>
</div>
